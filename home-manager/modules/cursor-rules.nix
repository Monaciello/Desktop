{ ... }:
{
  ...
  # 075: Obsidian / docs notes (on-demand via globs)
  home.file.".cursor/rules/075-obsidian-vault.mdc".source =
    ./dotfiles/cursor-rules/075-obsidian-vault.mdc;
  ...
  home.file.".cursor/rules/200-rust-mentor.mdc".source = ./dotfiles/cursor-rules/200-rust-mentor.mdc;
  ...
  home.file.".cursor/rules/350-python-nix.mdc".source = ./dotfiles/cursor-rules/350-python-nix.mdc;
